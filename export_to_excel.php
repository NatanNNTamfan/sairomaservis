...
$filter_info = "Filters: Start Date: $start_date, End Date: $end_date, Start Time: $start_time, End Time: $end_time, Search: $search, Status: $status";
$end_date = isset($_GET['end_date']) && !empty($_GET['end_date']) ? $_GET['end_date'] : date('Y-m-d');
$start_time = isset($_GET['start_time']) && !empty($_GET['start_time']) ? $_GET['start_time'] : '00:00:00';
$end_time = isset($_GET['end_time']) && !empty($_GET['end_time']) ? $_GET['end_time'] : '23:59:59';
$search = isset($_GET['search']) ? $_GET['search'] : '';
...
$sheet->setCellValue('A1', $filter_info);
